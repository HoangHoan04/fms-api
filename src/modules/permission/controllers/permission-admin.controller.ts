...
export class PermissionController {
  ...
  async deactivate(@Body() data: { id: string }, @CurrentUser() user: UserDto) {
    return await this.service.deactivate(data, user);
  }
  ...
  async activate(@Body() data: { id: string }, @CurrentUser() user: UserDto) {
    return await this.service.activate(data, user);
  }
  ...
  async assignPermissionsToRole(
    ...
    return await this.service.assignPermissionsToRole();
  }
  ...
  async removePermissionFromRole(
    ...
    return await this.service.removePermissionFromRole();
  }
  ...
  async assignPermissionToUser(
    ...
    return await this.service.assignPermissionToUser();
  }
  ...
  async removeUserPermission(
    ...
    return await this.service.removeUserPermission(data, user);
  }
